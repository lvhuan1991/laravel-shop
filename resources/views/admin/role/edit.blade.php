                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="">
                            <span class="hidden-sm-up"><i class="ti-user"></i></span> <span
                                class="hidden-xs-down">编辑角色</span>
                        </a>
                    </li>
                </ul>
                <!-- Tab panes -->
                    ...
                    <div class="card-body">
                        ...
                        <!--/row-->
                            <div class="form-group row">
                                <label class="control-label text-right col-md-3">角色中文名称</label>
                                <div class="col-md-9">
                                    <input type="text" placeholder="" name="title" value="{{$role['title']}}"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label text-right col-md-3">角色标识</label>
                                <div class="col-md-9">
                                    <input type="text" placeholder="" name="name" value="{{$role['name']}}"
                                           class="form-control">
                                </div>
                            </div>
                ...
                <script>
                    layui.use(['upload', 'layedit'], function () {
                        ...
                        upload.render({
                            ...
                            ,
                            acceptMime: "{{my_config ('upload.upload_accept_mime','image/jpg, image/png,image/jpeg')}}"
                            ,
                            size: "{{my_config ('upload.upload_size',20000000)}}" //最大允许上传的文件大小，单位 KB。不支持ie8/9
                            ,
                            exts: "{{my_config ('upload.upload_type','jpg|png|gif|bmp|jpeg')}}"
